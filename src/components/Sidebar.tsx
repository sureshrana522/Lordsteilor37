        ...
        <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1 scrollbar-hide">
          ...
          {showWorkFloor && (
            <>
              ...
              <p className="px-4 text-[9px] text-zinc-700 uppercase tracking-[0.2em] font-black mb-3">
                Live Work Floor
              </p>
          ...
          >
            <div
              className={`w-1.5 h-1.5 rounded-full animate-pulse ${
                !isDemoMode ? 'bg-emerald-500' : 'bg-orange-500'
              }`}
            />
            <p
              className={`text-[9px] font-black uppercase tracking-widest ${
                !isDemoMode ? 'text-emerald-500' : 'text-orange-500'
              }`}
            >
